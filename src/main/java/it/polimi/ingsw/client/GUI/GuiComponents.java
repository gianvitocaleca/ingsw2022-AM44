...
import static it.polimi.ingsw.client.GUI.GuiAssets.tableTowerHeight;
...
public class GuiComponents {
     ...
     */
    public static HBox towerCounter(it.polimi.ingsw.server.model.enums.Color color, int num) {
