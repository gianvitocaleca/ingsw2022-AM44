...
public class Commands {
    ...
    public static final String selectCreatureText = "c";
    public static final String selectIslandText = "i";
    public static final String selectDestinationText = "d";
    public static final String creatureSeparator = ",";
    public static final String quitCommandText = "quit";
